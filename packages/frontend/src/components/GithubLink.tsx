const REPO_URL = 'https://github.com/gjeon03/pinloom';

// Inline GitHub mark — lucide-react 1.8 doesn't ship a Github icon, so
// rather than upgrading or pulling in a second icon package we use the
// octocat path directly. currentColor lets it pick up the surrounding
// text color so theme switches Just Work.
